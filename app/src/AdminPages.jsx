...
function PolicyEditor({ onToast }) {
  const [policy, setPolicy] = useState({ work_hours_start: "09:00", work_hours_end: "18:00", activity_checkpoint_seconds: 15 });
